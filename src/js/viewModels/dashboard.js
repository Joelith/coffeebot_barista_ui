 ...
 */
define(['ojs/ojcore', 'knockout', 'jquery', 'mbe/mbe', 'moment', 'ojs/ojlistview', 'ojs/ojcollectiontabledatasource', 'ojs/ojmodel', 'ojs/ojbutton'],
 function(oj, ko, $, mbe, moment) {
    ...
    function DashboardViewModel() {
      var self = this;
	      ...
	      idAttribute: 'id',
        url: 'CoffeeServices/orders',
        sync: mbe.mcsSync
	    });
	    var collectionDef = oj.Collection.extend({
	      url: 'CoffeeServices/orders?status=ordered',
	      model: model,
	      sync: mbe.mcsSync,
